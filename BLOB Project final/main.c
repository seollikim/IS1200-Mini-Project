...
#include "blob.h"  /* Declatations for these blob game */
#include <stdio.h>
#include <stdlib.h>
...
int main(void) { // taken from lab
	...
	*/
	...
	void start_Screen(){ //the first screen that is shown 
		...
		display_string(0, "Welcome to Blob");
		display_string(1, "SW 3: Start");
		display_string(2, "SW 2: Help");
	...
	void end() { //game over screen
		...
		display_string(2, itoaconv(pointscounter));
	...
	void help() {
		...
		display_string(0, "L/R: btn 1/2 ");
		display_string(1, "U/D: btn 4/3");
		display_string(2, "btn 1: Main");
		display_string(3, "");
